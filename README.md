# coverage [![Coverage Status](https://coveralls.io/repos/yglukhov/coverage/badge.png?branch=master&service=github)](https://coveralls.io/github/yglukhov/coverage?branch=master)
